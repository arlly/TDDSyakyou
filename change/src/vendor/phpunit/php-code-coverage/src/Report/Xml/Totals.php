...
class Totals
{
    ...
    public function setNumLines($loc, $cloc, $ncloc, $executable, $executed)
    {
        ...
        $this->linesNode->setAttribute('percent', Util::percent($executed, $executable, true));
    }
    ...
    public function setNumClasses($count, $tested)
    {
        ...
        $this->classesNode->setAttribute('percent', Util::percent($tested, $count, true));
    }
    ...
    public function setNumTraits($count, $tested)
    {
        ...
        $this->traitsNode->setAttribute('percent', Util::percent($tested, $count, true));
    }
    ...
    public function setNumMethods($count, $tested)
    {
        ...
        $this->methodsNode->setAttribute('percent', Util::percent($tested, $count, true));
    }
