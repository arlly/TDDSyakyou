...
class PHPUnit_Framework_MockObject_Matcher implements PHPUnit_Framework_MockObject_Matcher_Invocation
{
    ...
    {
        if ($this->invocationMatcher === null) {
            throw new PHPUnit_Framework_MockObject_RuntimeException('No invocation matcher is set');
        }
        ...
        if ($this->afterMatchBuilderId !== null) {
            ...
            if (! $builder) {
                throw new PHPUnit_Framework_MockObject_RuntimeException(sprintf('No builder found for match builder identification <%s>', $this->afterMatchBuilderId));
            }
