...
, PHPUnit_Framework_TestFailure::exceptionToString($e));
    ...
    {
        $constraint = PHPUnit_Framework_Assert::logicalNot(PHPUnit_Framework_Assert::stringContains('oryginał'));
...
, PHPUnit_Framework_TestFailure::exceptionToString($e));
    ...
    {
        $constraint = PHPUnit_Framework_Assert::logicalNot(PHPUnit_Framework_Assert::stringContains('oryginał', false));
