...
class ArrayComparatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertTrue($this->comparator->accepts(array(), array()));
    }
    ...
    {
        $this->setExpectedException('SebastianBergmann\\Comparator\\ComparisonFailure', 'Failed asserting that two arrays are equal');
        $this->comparator->assertEquals($expected, $actual, $delta, $canonicalize);
    }
}
